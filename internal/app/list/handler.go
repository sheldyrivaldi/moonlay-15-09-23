...
func NewHandler(f *factory.Factory) *handler {
	service := NewListService(f)
	return &handler{service}
}

func (h *handler) FindAll(c echo.Context) error {
	payload := new(listdto.FindAllRequest)
	...
	if c.QueryParam("subList") != "" && c.QueryParam("subList") == "true" {
		payload.Sublist = true
	}
...
func (h handler) FindByID(c echo.Context) error {
	payload := new(listdto.FindByIDRequest)
...
func (h handler) Create(c echo.Context) error {
	payload := new(listdto.CreateRequest)
...
func (h handler) UpdateByID(c echo.Context) error {
	payload := new(listdto.UpdateByIDRequest)
	payloadData := new(listdto.FindByIDRequest)
...
func (h handler) DeleteByID(c echo.Context) error {
	payload := new(listdto.DeleteByIDRequest)
	payloadData := new(listdto.FindByIDRequest)
